  ...
  return (
    <main className="p-3 flex flex-col max-w-6xl mx-auto min-h-screen">
      ...
      <img
        src={post && post.image}
        alt={post && post.title}
        className="mt-10 pt-3 max-h-[600px] w-full object-cover"
      />
      <div className="flex justify-between border-b border-slate-500 mx-auto w-full max-w-2xl text-xs font-serif">
